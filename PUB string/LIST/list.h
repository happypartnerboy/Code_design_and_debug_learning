...
/*
 * Insert a one entry between two known consecutive entries. 
 *
...
/**
 * list_add - add a one entry
 * @one: one entry to be added
 * @head: list head to add it after
 *
 * Insert a one entry after the specified head.
...
/**
 * list_add_tail - add a one entry
 * @one: one entry to be added
 * @head: list head to add it before
 *
 * Insert a one entry before the specified head.
